...
public class RedisSessionManager extends ManagerBase implements Lifecycle {
	...
	//  protected Pool<BinaryJedisCluster> connectionPool;
	protected JedisPoolConfig connectionPoolConfig = new JedisPoolConfig();

	protected BinaryJedisCluster jedis = null;
	...
	protected BinaryJedisCluster acquireConnection(){
	  /*
...
//      connectionPool.destroy();
	...
	protected boolean saveInternal(BinaryJedisCluster jedis, Session session, boolean forceSave) throws IOException{
		Boolean error = true;
